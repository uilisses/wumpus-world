...
function moveAgent(direction) {
    ...
    // Adicionar regra de pontuação para movimento
/*     score -= 1;
    moves += 1; */
    /* updateGameStats(); */
...
function startAutoPlay() {
    ...
    autoPlayInterval = setInterval(agentV1Logic, 500); //Define a velocidade do Agent
}
...
// Verifica se é um movimento inválido

function isMovementInvalid() {
    const message = gameMessage.textContent;
    return message.includes('inválido');
}
